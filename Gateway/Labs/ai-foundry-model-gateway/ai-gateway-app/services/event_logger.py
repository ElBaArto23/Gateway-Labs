...
event_logger.py
================
Mecanismo de registro de eventos (Event Logger). Mide tiempos y guarda
el estado de cada etapa para que el frontend (o el módulo "Flujo del
Sistema" del dashboard) pueda representarla.
"""
...
# Debe coincidir 1:1 con el arreglo STAGES definido en script.js del dashboard
STAGE_LABELS = {
